...
/**
 * Contrôleur responsable de la gestion des tâches.
 * 
 * Cette classe gère les endpoints permettant de créer, mettre à jour, récupérer, supprimer
 * et récupérer des tâches en temps réel.
 * 
 * Elle utilise Spring WebFlux et des événements Server-Sent Events (SSE) pour notifier 
 * les mises à jour des tâches aux clients abonnés.
 * 
 * @author Courné Jules
 * @version 1.0
 */
...
public class TaskController {
    ...
    /** 
     * Service des tâches pour gérer les opérations liées aux tâches. 
     */
    private TaskService taskService;

    /** 
     * Sinks pour diffuser les mises à jour des tâches sous forme d'événements. 
     */
